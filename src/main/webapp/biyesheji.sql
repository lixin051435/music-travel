...
INSERT INTO `permission` VALUES (17, '添加景点分类', '添加景点分类', '/category/addCategory');
...
INSERT INTO `permission` VALUES (29, '添加景点', '添加上线商品', '/product/addProduct');
...
INSERT INTO `permission` VALUES (33, '添加景点界面', '暂无', '/product/productAddUI');
...
CREATE TABLE `product`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '景点名称',
